### This code isn't my work! Was used for reference with slight modifications ###
...
class RCRDING:
    def __init__(self):
        bag = r'test.bag' # Can change this to wherever bag was saved 
    ...
    def img_work(self, img,x,y):
        ...
        cv2.putText(img, '{0:.5}'.format(ans), (self.ix, self.iy), font, fontScale, fontColor,lineType)
